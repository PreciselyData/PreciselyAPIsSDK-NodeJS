...
export class PropertyInformationServiceApi {
   ...
   /* })
     ...
     * @param address free form address text
     * @param attributeFilter Case-insensitive comma separated values of property attributes. Response will contain only the input attributes.
     */
    public getPropertyAttributesByAddress (address?: string, attributeFilter?: string) : Promise<{ response: http.IncomingMessage; body: PropertyInfoResponse;  }> {
