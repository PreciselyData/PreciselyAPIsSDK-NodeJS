...
var GeoPropertyAddressRequest = (function () {
    function GeoPropertyAddressRequest() {
    }
    return GeoPropertyAddressRequest;
}());
exports.GeoPropertyAddressRequest = GeoPropertyAddressRequest;
var GeoPropertyResponse = (function () {
    function GeoPropertyResponse() {
    }
    return GeoPropertyResponse;
}());
exports.GeoPropertyResponse = GeoPropertyResponse;
var GeoPropertyResponses = (function () {
    function GeoPropertyResponses() {
    }
    return GeoPropertyResponses;
}());
exports.GeoPropertyResponses = GeoPropertyResponses;
...
var PropertyInformationServiceApi = (function () {
    ...
    PropertyInformationServiceApi.prototype.getGeoPropertyByAddress = function (address) {
        var localVarPath = this.basePath + '/property/v1/all/attributes/byaddress';
        var queryParameters = {};
        var headerParams = this.defaultHeaders;
        var formParams = {};
        if (address === null || address === undefined) {
    ...
    PropertyInformationServiceApi.prototype.getGeoPropertyByAddressBatch = function (body) {
        var localVarPath = this.basePath + '/property/v1/all/attributes/byaddress';
        var queryParameters = {};
        var headerParams = this.defaultHeaders;
        var formParams = {};
